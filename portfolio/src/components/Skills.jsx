...
const Skills = () => {
  return (
    <div className='h-max w-full bg-primary'>
      ...
      {/* Mobile */}
      <div className='flex lg:hidden h-page flex-col'>
        <div className='flex flex-col justify-center items-center'>
          {/* row 1 */}
          <div className='h-[304px] bg-primary flex justify-center items-center'>
            <img src="/images/wave-blue.png" alt="" />
          </div>
          ...
          {/* row 3 */}
          <div className='h-[304px] bg-primary flex justify-center items-center relative'>
            <img src="/images/cloud-blue.png" alt="" />
          </div>
